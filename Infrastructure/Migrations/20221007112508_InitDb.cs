        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ingredient = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Foods_CourseTypes_CourseTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodType", x => new { x.TypeId, x.FoodId });
                    table.ForeignKey(
                        name: "FK_FoodType_Foods_FoodId",
                        column: x => x.FoodId,
                        principalTable: "Foods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FoodType_Types_TypeId",
                        column: x => x.TypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(300)", nullable: false),
                    TableId = table.Column<int>(type: "int", nullable: false),
                    NumOfPeople = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Foods_CourseTypeId",
                table: "Foods",
                column: "CourseTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodType_FoodId",
                table: "FoodType",
                column: "FoodId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodType_TypeId",
                table: "FoodType",
                column: "TypeId");
